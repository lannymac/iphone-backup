This program will read in the sql database made by iTunes during an iPhone backup. The sms messages will be obtained and with the sms class, slight analysis can be performed.
